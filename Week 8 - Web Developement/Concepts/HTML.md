...
__HTML__ or __hypertext markup language__ is made up of __tags__, each of which may have some __attributes__ that describe it.
...
![html code next to a hierarchy showing parent and child nodes](https://cs50.harvard.edu/x/notes/8/cs50Week8Slide065.png "DOM")
...
Notice that the `<a>` or __anchor__ tag is used to make `Harvard` a linkable text.
